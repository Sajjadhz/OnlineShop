...
def add_user_order(request):
    ...
    if new_order_form.is_valid():
        ...
        # print(f'/products/{product.id}/{product.title.replace(" ", "-")}')
...
MERCHANT = 'XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX'  # need to register in zarinpal site to get this code
...
def verify(request, *args, **kwargs):
    ...
    if request.GET.get('Status') == 'OK':
        ...
        if result.Status == 100:
            ...
            user_order.save()
            return HttpResponse('Transaction success.\nRefID: ' + str(result.RefID))  # refID is tracking code
